...
class CategoryImageService {
  ...
  static Future<String> uploadCategoryImage({
    ...
    try {
      if (kDebugMode) {
        print('🔄 Starting category image upload...');
        print(
      ...
      final finalFileName = fileName ?? 'category_$timestamp.jpg';
      final storagePath = 'categories/$finalFileName';
  ...
  static Future<String> uploadCategoryImageFromXFile({
    ...
    try {
      ...
      final timestamp = DateTime.now().millisecondsSinceEpoch;
      final finalFileName =
          fileName ?? 'category_$timestamp.${xFile.name.split('.').last}';
      final storagePath = 'categories/$finalFileName';
  ...
  static Future<void> deleteCategoryImage(String imageUrl) async {
    try {
      if (kDebugMode) {
